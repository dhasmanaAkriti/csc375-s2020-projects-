...
/*
 * Creates a graphviz-formatted file showing the contents of the
 * ast. The resulting file can be viewed using dotty.
 *
 *  outfile: the file to which to write
 *  tree: the ast to show
 *  print_func: function to call to print out the ast_info for each node
 */
void create_graphviz(FILE *outfile, ast tree,
